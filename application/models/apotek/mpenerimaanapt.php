...
/*$query1=$this->db->query("select urut from apt_penerimaan_detail where no_penerimaan='$no_penerimaan'");
		...
		$query=$this->db->query("select apt_penerimaan_detail.no_pemesanan,apt_penerimaan_detail.kd_obat,apt_penerimaan_detail.urut,apt_penerimaan_detail.no_penerimaan,apt_penerimaan_detail.kd_pabrik, apt_obat.nama_obat, apt_satuan_kecil.satuan_kecil, date_format(apt_penerimaan_detail.tgl_expire,'%d-%m-%Y') as tgl_expire,
				...
				apt_penerimaan_detail.no_batch,apt_penerimaan_detail.kode_sas from apt_obat, apt_satuan_kecil, apt_penerimaan_detail, apt_penerimaan, apt_unit 
