...
class Laporanapt extends Rumahsakit
{
	...
	{ //bwt yg penjualan obat
		...
		$objPHPExcel->getActiveSheet()->getColumnDimensionByColumn(1)->setWidth(25); //TGL JUAL
		$objPHPExcel->getActiveSheet()->getColumnDimensionByColumn(2)->setWidth(13); //NO JUAL
		$objPHPExcel->getActiveSheet()->getColumnDimensionByColumn(3)->setWidth(30); //KODE
		$objPHPExcel->getActiveSheet()->getColumnDimensionByColumn(4)->setWidth(20); //NAMA
		...
		$objPHPExcel->getActiveSheet()->setCellValue('B4', 'No SBBK');
		$objPHPExcel->getActiveSheet()->setCellValue('C4', 'Tanggal');
		$objPHPExcel->getActiveSheet()->setCellValue('D4', 'Tujuan Instansi');
		...
		foreach ($items as $item) {
			...
			$objPHPExcel->getActiveSheet()->setCellValue('A' . $baris, $nomor);
			$objPHPExcel->getActiveSheet()->setCellValue('B' . $baris, $item['no_sbbk']);
			$objPHPExcel->getActiveSheet()->setCellValue('C' . $baris, convertDate($item['tgl_penjualan']));
			$objPHPExcel->getActiveSheet()->setCellValue('D' . $baris, $item['puskesmas']);
