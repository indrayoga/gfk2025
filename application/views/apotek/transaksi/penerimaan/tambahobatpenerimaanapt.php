											...
											<table class="table responsive">
												<thead>
													<tr style="font-size:80% !important;">
														...
														<th class="header" style="width:50px;padding:0 !important;text-align:center;">SAS</th>
												...
												<tbody id="bodyinput">
													...
													?>
															<tr style="font-size:80% !important;">
																<td style="text-align:center;padding:0 !important;">&nbsp;</td>
																...
																<td style="padding:0 !important;"><input <?php if ($this->mpenerimaanapt->isPosted($no_penerimaan)) echo "readonly"; ?> type="text" value="<?php echo $itemdetil['kode_sas'] ?>" style="width:50px;font-size:90% !important;" class="input-small barisbonus cleared"></td>
