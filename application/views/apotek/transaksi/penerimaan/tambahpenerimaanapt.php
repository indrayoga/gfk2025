														...
														<tbody id="bodyinput">
															<?php
																if(isset($itemsdetiltransaksi)){
																	...
																	?>
																		<tr style="font-size:80% !important;"><td style="text-align:center;padding:0 !important;">
																			<input type="checkbox" <?php if($this->mpenerimaanapt->isPosted($no_penerimaan))echo "disabled"; ?> class="barisinput cleared" /></td>
