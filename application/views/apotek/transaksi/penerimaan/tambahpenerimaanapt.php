...
<style>
	...
	#listobat .ui-selecting,
	#listobat .ui-selecting {
		background: #FECA40;
	}

	#listobat .ui-selected,
	#listobat .ui-selected {
		background: #F39814;
		color: white;
	}
...
<script type="text/javascript">
	Mousetrap.bindGlobal('ctrl+r', function() {
		window.location.href = '<?php echo base_url() ?>index.php/transapotek/aptpenerimaan/tambahpenerimaanapt';
		return false;
	});
	Mousetrap.bindGlobal('f7', function() {
	...
	Mousetrap.bind('a', function(e) {
		if ($('#tesxx').is(':visible')) {
			$('.focused .barisnamaobat').val($('.focused .barisnamaobat').val() + 'a');
			$('.focused .barisnamaobat').focus();
		}
		return false;
	});
	Mousetrap.bind('b', function(e) {
		if ($('#tesxx').is(':visible')) {
			$('.focused .barisnamaobat').val($('.focused .barisnamaobat').val() + 'b');
			$('.focused .barisnamaobat').focus();
		}
		return false;
	});
	Mousetrap.bind('c', function(e) {
		if ($('#tesxx').is(':visible')) {
			$('.focused .barisnamaobat').val($('.focused .barisnamaobat').val() + 'c');
			$('.focused .barisnamaobat').focus();
		}
		return false;
	});
	Mousetrap.bind('d', function(e) {
		if ($('#tesxx').is(':visible')) {
			$('.focused .barisnamaobat').val($('.focused .barisnamaobat').val() + 'd');
			$('.focused .barisnamaobat').focus();
		}
		return false;
	});
	Mousetrap.bind('e', function(e) {
		if ($('#tesxx').is(':visible')) {
			$('.focused .barisnamaobat').val($('.focused .barisnamaobat').val() + 'e');
			$('.focused .barisnamaobat').focus();
		}
		return false;
	});
	Mousetrap.bind('f', function(e) {
		if ($('#tesxx').is(':visible')) {
			$('.focused .barisnamaobat').val($('.focused .barisnamaobat').val() + 'f');
			$('.focused .barisnamaobat').focus();
		}
		return false;
	});
	Mousetrap.bind('g', function(e) {
		if ($('#tesxx').is(':visible')) {
			$('.focused .barisnamaobat').val($('.focused .barisnamaobat').val() + 'g');
			$('.focused .barisnamaobat').focus();
		}
		return false;
	});
	Mousetrap.bind('h', function(e) {
		if ($('#tesxx').is(':visible')) {
			$('.focused .barisnamaobat').val($('.focused .barisnamaobat').val() + 'h');
			$('.focused .barisnamaobat').focus();
		}
		return false;
	});
	Mousetrap.bind('i', function(e) {
		if ($('#tesxx').is(':visible')) {
			$('.focused .barisnamaobat').val($('.focused .barisnamaobat').val() + 'i');
			$('.focused .barisnamaobat').focus();
		}
		return false;
	});
	Mousetrap.bind('j', function(e) {
		if ($('#tesxx').is(':visible')) {
			$('.focused .barisnamaobat').val($('.focused .barisnamaobat').val() + 'j');
			$('.focused .barisnamaobat').focus();
		}
		return false;
	});
	Mousetrap.bind('k', function(e) {
		if ($('#tesxx').is(':visible')) {
			$('.focused .barisnamaobat').val($('.focused .barisnamaobat').val() + 'k');
			$('.focused .barisnamaobat').focus();
		}
		return false;
	});
	Mousetrap.bind('l', function(e) {
		if ($('#tesxx').is(':visible')) {
			$('.focused .barisnamaobat').val($('.focused .barisnamaobat').val() + 'l');
			$('.focused .barisnamaobat').focus();
		}
		return false;
	});
	Mousetrap.bind('m', function(e) {
		if ($('#tesxx').is(':visible')) {
			$('.focused .barisnamaobat').val($('.focused .barisnamaobat').val() + 'm');
			$('.focused .barisnamaobat').focus();
		}
		return false;
	});
	Mousetrap.bind('n', function(e) {
		if ($('#tesxx').is(':visible')) {
			$('.focused .barisnamaobat').val($('.focused .barisnamaobat').val() + 'n');
			$('.focused .barisnamaobat').focus();
		}
		return false;
	});
	Mousetrap.bind('o', function(e) {
		if ($('#tesxx').is(':visible')) {
			$('.focused .barisnamaobat').val($('.focused .barisnamaobat').val() + 'o');
			$('.focused .barisnamaobat').focus();
		}
		return false;
	});
	Mousetrap.bind('p', function(e) {
		if ($('#tesxx').is(':visible')) {
			$('.focused .barisnamaobat').val($('.focused .barisnamaobat').val() + 'p');
			$('.focused .barisnamaobat').focus();
		}
		return false;
	});
	Mousetrap.bind('q', function(e) {
		if ($('#tesxx').is(':visible')) {
			$('.focused .barisnamaobat').val($('.focused .barisnamaobat').val() + 'q');
			$('.focused .barisnamaobat').focus();
		}
		return false;
	});
	Mousetrap.bind('r', function(e) {
		if ($('#tesxx').is(':visible')) {
			$('.focused .barisnamaobat').val($('.focused .barisnamaobat').val() + 'r');
			$('.focused .barisnamaobat').focus();
		}
		return false;
	});
	Mousetrap.bind('s', function(e) {
		if ($('#tesxx').is(':visible')) {
			$('.focused .barisnamaobat').val($('.focused .barisnamaobat').val() + 's');
			$('.focused .barisnamaobat').focus();
		}
		return false;
	});
	Mousetrap.bind('t', function(e) {
		if ($('#tesxx').is(':visible')) {
			$('.focused .barisnamaobat').val($('.focused .barisnamaobat').val() + 't');
			$('.focused .barisnamaobat').focus();
		}
		return false;
	});
	Mousetrap.bind('u', function(e) {
		if ($('#tesxx').is(':visible')) {
			$('.focused .barisnamaobat').val($('.focused .barisnamaobat').val() + 'u');
			$('.focused .barisnamaobat').focus();
		}
		return false;
	});
	Mousetrap.bind('v', function(e) {
		if ($('#tesxx').is(':visible')) {
			$('.focused .barisnamaobat').val($('.focused .barisnamaobat').val() + 'v');
			$('.focused .barisnamaobat').focus();
		}
		return false;
	});
	Mousetrap.bind('w', function(e) {
		if ($('#tesxx').is(':visible')) {
			$('.focused .barisnamaobat').val($('.focused .barisnamaobat').val() + 'w');
			$('.focused .barisnamaobat').focus();
		}
		return false;
	});
	Mousetrap.bind('x', function(e) {
		if ($('#tesxx').is(':visible')) {
			$('.focused .barisnamaobat').val($('.focused .barisnamaobat').val() + 'x');
			$('.focused .barisnamaobat').focus();
		}
		return false;
	});
	Mousetrap.bind('y', function(e) {
		if ($('#tesxx').is(':visible')) {
			$('.focused .barisnamaobat').val($('.focused .barisnamaobat').val() + 'y');
			$('.focused .barisnamaobat').focus();
		}
		return false;
	});
	Mousetrap.bind('z', function(e) {
		if ($('#tesxx').is(':visible')) {
			$('.focused .barisnamaobat').val($('.focused .barisnamaobat').val() + 'z');
			$('.focused .barisnamaobat').focus();
		}
		return false;
	});
	Mousetrap.bind('space', function(e) {
		if ($('#tesxx').is(':visible')) {
			$('.focused .barisnamaobat').val($('.focused .barisnamaobat').val() + ' ');
			$('.focused .barisnamaobat').focus();
		}
		return false;
	});
								...
								<header class="top" style="">
									...
									<div class="toolbar" style="height:auto;">
										<ul class="nav nav-tabs">
											...
											<li><a target="_blank" class="btn" id="btn-cetak" style="border-style:solid;border-width:1px;line-height: 21px !important;padding: 4px 12px;border-bottom:1px solid !important;border-color: rgba(0, 0, 0, 0.1) rgba(0, 0, 0, 0.1) #B3B3B3 !important;" href="<?php if (!empty($no_penerimaan)) {
																																																																												echo base_url() ?>third-party/fpdf/buktipenerimaan.php?no_penerimaan=<?php echo $no_penerimaan;
																																																																																													} else echo '#'; ?>" <?php if (empty($no_penerimaan)) { ?>disabled<?php } ?>> <i class="icon-print"></i> Cetak</a></li>
										...
										<div class="span12">
											...
											<div class="span7">
												...
												<div class="controls with-tooltip">
													...
													<span class="help-inline"></span>
													Tgl. Faktur <input <?php if ($this->mpenerimaanapt->isPosted($no_penerimaan)) echo "readonly"; ?> type="text" name="tgl_faktur" id="tgl_faktur" class="input-small input-tooltip cleared" data-original-title="tgl faktur" data-mask="99-99-9999" value="<?php if (empty($itemtransaksi['tgl_faktur'])) echo date('d-m-Y');
																																																																												else echo convertDate($itemtransaksi['tgl_faktur']);  ?>" data-placement="bottom" />
												</div>
											</div>
										</div>
									</div>
										...
										<div class="span12">
											<div class="span5">
												<div class="control-group">
													...
													<div class="controls with-tooltip">
														<input <?php if ($this->mpenerimaanapt->isPosted($no_penerimaan)) echo "readonly"; ?> type="text" name="tgl_penerimaan" id="tgl_penerimaan" class="input-small input-tooltip cleared" data-original-title="tgl penerimaan" data-mask="99-99-9999" value="<?php if (empty($itemtransaksi['tgl_penerimaan'])) echo date('d-m-Y');
																																																																													else echo convertDate($itemtransaksi['tgl_penerimaan']);  ?>" data-placement="bottom" />
														<span class="help-inline"></span>
										...
										<div class="span12">
											<div class="span5">
												<div class="control-group">
													...
													<div class="controls with-tooltip">
														<input <?php if ($this->mpenerimaanapt->isPosted($no_penerimaan)) echo "readonly"; ?> type="text" name="tgl_tempo" id="tgl_tempo" class="input-small input-tooltip cleared" data-original-title="tgl tempo" data-mask="99-99-9999" value="<?php if (empty($itemtransaksi['tgl_tempo'])) echo date('d-m-Y');
																																																																									else echo convertDate($itemtransaksi['tgl_tempo']);  ?>" data-placement="bottom" />
														<span class="help-inline"></span>
													...
													<div class="controls with-tooltip">
														<select class="input-xlarge cleared" <?php if ($this->mpenerimaanapt->isPosted($no_penerimaan)) echo "readonly"; ?> name="kd_unit_apt" id="kd_unit_apt" required>
															...
															foreach ($sumberdana as $sd) {
																...
																if (isset($itemtransaksi['kd_unit_apt']) && $itemtransaksi['kd_unit_apt'] == $sd['kd_unit_apt']) $select = "selected=selected";
																else $select = "";
											...
											<div class="span7">
												<div class="control-group">
													...
													<div class="controls with-tooltip">
														...
														<span class="help-inline"></span>
														<input type="hidden" name="tgl_entry" id="tgl_entry" class="input-small input-tooltip cleared" data-original-title="tgl entry" data-mask="9999-99-99" value="<?php if (empty($tgl_entry)) echo date('Y-m-d');
																																																						else echo convertDate($tgl_entry); ?>" data-placement="bottom" />
											...
											<table class="table responsive">
												<thead>
													<tr style="font-size:80% !important;">
														...
														<th class="header" style="width:50px;padding:0 !important;text-align:center;">Kode SAS</th>
													...
													?>
															<tr style="font-size:80% !important;">
																<td style="text-align:center;padding:0 !important;">
																	<input type="checkbox" <?php if ($this->mpenerimaanapt->isPosted($no_penerimaan)) echo "disabled"; ?> class="barisinput cleared" />
																</td>
																<td style="padding:0 !important;"><input <?php if ($this->mpenerimaanapt->isPosted($no_penerimaan)) echo "readonly"; ?> type="text" name="kd_obat[]" value="<?php echo $itemdetil['kd_obat'] ?>" autocomplete="off" class="input-small bariskodeobat cleared"></td>
																<td style="text-align:center;">
																	<select class="input-small bariskodepabrik cleared" name="kd_pabrik[]" id="kd_pabrik">
																		<option value="">Pilih Pabrik</option>
																		<?php foreach ($datapabrik as $pabrik) {
																			$select = "";
																			if (isset($pabrik['kd_pabrik'])) {
																				if ($itemdetil['kd_pabrik'] == $pabrik['kd_pabrik']) $select = "selected=selected";
																				else $select = "";
																			}
																		?>
																...
																<!--<td style="padding:0 !important;"><input <?php if ($this->mpenerimaanapt->isPosted($no_penerimaan)) echo "readonly"; ?> type="text" name="no_pemesanan[]" value="<?php echo $itemdetil['no_pemesanan'] ?>" style="width:110px;font-size:90% !important;" class="input-small barisnopesan cleared"></td>
																			-->
																<td style="padding:0 !important;"><input <?php if ($this->mpenerimaanapt->isPosted($no_penerimaan)) echo "readonly"; ?> type="text" name="nama_obat[]" value="<?php echo $itemdetil['nama_obat'] ?>" autocomplete="off" style="font-size:90% !important;" class="input-xlarge barisnamaobat cleared"></td>
																...
																<td style="padding:0 !important;display:none;"><input <?php if ($this->mpenerimaanapt->isPosted($no_penerimaan)) echo "readonly"; ?> type="text" name="disc_prs[]" value="<?php echo $discpers; ?>" style="width:40px;font-size:90% !important;" class="input-small barisdisc cleared"></td>
																<input style="text-align:right;display:none;" type="hidden" name="harga_belidisc[]" value="<?php echo $hbdisc; ?>" style="width:60px;font-size:90% !important;" class="input-small barishargabelidisc cleared" readonly>
																<td style="padding:0 !important;display:none;"><input <?php if ($this->mpenerimaanapt->isPosted($no_penerimaan)) echo "readonly"; ?> style="text-align:right;" type="text" name="isidiskon[]" value="<?php echo number_format($diskon, 2, '.', ''); ?>" style="width:60px;font-size:90% !important;" class="input-small barisisidiskon cleared"></td>
																...
																<td style="padding:0 !important;display:none;"><input <?php if ($this->mpenerimaanapt->isPosted($no_penerimaan)) echo "readonly"; ?> type="text" name="ppn_item[]" value="<?php echo $ppn; ?>" style="width:40px;font-size:90% !important;" class="input-small barisppn cleared"></td>
																...
																<td style="padding:0 !important;"><input <?php if ($this->mpenerimaanapt->isPosted($no_penerimaan)) echo "readonly"; ?> type="text" name="kode_sas[]" value="<?php echo $itemdetil['kode_sas'] ?>" style="width:50px;font-size:90% !important;" class="input-small bariskodesas cleared"></td>
												...
												<tfoot>
													...
													<tr>
														<th colspan="12" style="text-align:right;" class="header">PPN (%) : <input <?php if ($this->mpenerimaanapt->isPosted($no_penerimaan)) echo "readonly"; ?> type="text" class="input-medium cleared" id="discount" name="ppn" value="11" style="text-align:right"></th>
											...
											<div class="span12">
												<div class="control-group">
													...
													<div class="controls with-tooltip">
														...
														<input type="hidden" name="jenis" id="jenis" value="<?php if ($this->mpenerimaanapt->isPosted($no_penerimaan)) {
																												echo 1;
																											} else {
																												echo 0;
																											} ?>" class="input-mini input-tooltip cleared" data-original-title="jenis" data-placement="bottom" />
													</div>
												</div>
											</div>
										</div>
...
<script type="text/javascript">
	...
	$('#tambahbaris').click(function() {
		...
		$('#bodyinput').append('<tr class="focused" style="font-size:80% !important;"><td style="text-align:center;padding:0 !important;"><input type="checkbox" class="barisinput cleared" /></td>' +
			...
			'<td style="padding:0 !important;"><input type="text" name="kode_sas[]" value="" style="width:50px;font-size:90% !important;" class="input-small bariskodesas cleared"></td>' +
		...
		$('#dataTable4').dataTable({
			...
			"fnServerParams": function(aoData) {
				aoData.push({
					"name": "nama_obat",
					"value": "" + $('.focused').find('.barisnamaobat').val() + ""
				});
				aoData.push({
					"name": "kd_unit_apt",
					"value": $("#kd_unit_apt").val()
				});
				aoData.push({
					"name": "kd_pabrik",
					"value": $('.focused').find('.bariskodepabrik').val()
				});
			}
