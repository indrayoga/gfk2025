	...
	<div class="container-fluid outer">
		<div class="row-fluid">
			...
			<div class="span12 inner">
				...
				<div class="row-fluid">
					<form class="form-horizontal" id="form" method="post" action="<?php echo base_url() ?>index.php/masterapotek/obat/update">
						<div class="row-fluid">
							<div class="span12">
								<div class="box">
									<header>
									...
									<div id="div-1" class="accordion-body collapse in body">
													...
													<div class="control-group">
														...
														<div class="controls with-tooltip">
															<input type="text" name="kd_obat" id="kd_obat" class="span5 input-tooltip"
																value="<?php echo $items['kd_obat'] ?>" data-original-title="kd obat" data-placement="bottom" />
															<input type="hidden" name="kd_obat_lama" id="kd_obat_lama" class="span5 input-tooltip"
																value="<?php echo $items['kd_obat'] ?>" data-original-title="kd obat" data-placement="bottom" />
															&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Aktif &nbsp&nbsp<input type="checkbox" id="is_aktif" name="is_aktif" value="1" <?php echo set_checkbox('is_aktif', '1', isset($items['is_aktif']) && $items['is_aktif'] == '1' ? true : false); ?> />
											...
											<div class="span12">
												<div class="span6">
													<div class="control-group">
														...
														<div class="controls with-tooltip">
															<input type="hidden" name="kd_produk" id="kd_produk" class="span5 input-tooltip" value="<?php echo $items['kd_produk'] ?>" data-original-title="kd produk" data-placement="bottom" />
															<span class="help-inline"></span>
														</div>
													</div>
												</div>
													...
													<div class="control-group">
														...
														<div class="controls with-tooltip">
															<input type="text" name="nama_obat" id="nama_obat" class="span11 input-tooltip"
																value="<?php if (isset($items['nama_obat'])) echo $items['nama_obat'] ?>" data-original-title="nama obat / alkes" data-placement="bottom" />
															<span class="help-inline"></span>
														</div>
													</div>
												</div>
										...
										<div class="row-fluid">
											<div class="span12">
												<div class="span7">
													<div class="control-group">
														<label for="kd_kategori" class="control-label">Kategori Obat</label>
														<div class="controls with-tooltip">
															<select name="kd_kategori" class="input-medium">
																<option value="">--pilih Kategori--</option>
																<option value="obat" <?=($items['kd_kategori']=='obat')?'selected=selected':''?>>Obat</option>
																<option value="bmhp"  <?=($items['kd_kategori']=='bmhp')?'selected=selected':''?>>BMHP</option>
																<option value="bahan_gigi" <?=($items['kd_kategori']=='bahan_gigi')?'selected=selected':''?>>Bahan Gigi</option>
																<option value="bahan_kimia" <?=($items['kd_kategori']=='bahan_kimia')?'selected=selected':''?>>Bahan Kimia/Reagen</option>
															</select>
															<span class="help-inline"></span>
														</div>
													</div>
														...
														<div class="controls with-tooltip">
															<select name="kd_satuan_kecil" class="input-medium">
																...
																foreach ($datakecil as $kecil) {
																	# code...
																	$select = "";
																	if (isset($items['kd_satuan_kecil'])) {
																		//debugvar($kecil['kd_satuan_kecil']);  
																		if (strtoupper($items['kd_satuan_kecil']) == $kecil['kd_satuan_kecil']) {
																			//debugvar($kecil['kd_satuan_kecil']); 
																			$select = "selected=selected";
																		} else $select = "";
																	}
																?>
																	<option value="<?php echo $kecil['kd_satuan_kecil'] ?>" <?php echo $select; ?>><?php echo $kecil['satuan_kecil'] ?></option>
																<?php
																}
																?>
															</select>
															...
															<select name="kd_pabrik" class="input-large">
																...
																foreach ($datapabrik as $pab) {
																	# code...
																	$select = "";
																	if (isset($items['kd_pabrik'])) {
																		if ($items['kd_pabrik'] == $pab['kd_pabrik']) $select = "selected=selected";
																		else $select = "";
																	}
																?>
																	<option value="<?php echo $pab['kd_pabrik'] ?>" <?php echo $select; ?>><?php echo $pab['nama_pabrik'] ?></option>
																<?php
																}
																?>
															</select>
														...
														<div class="controls with-tooltip">
															<select name="kd_therapi" class="input-medium">
																...
																foreach ($datatherapi as $therapi) {
																	# code...
																	if ($therapi['kd_therapi'] == $items['kd_therapi']) $sel = "selected=selected";
																	else $sel = "";
																?>
																	<option value="<?php echo $therapi['kd_therapi'] ?>" <?php echo $sel; ?>><?php echo $therapi['therapi'] ?></option>
																<?php
																}
																?>
															</select>
															...
															<select id="fornas" name="fornas" class="input-medium">
																...
																<option value="1" <?php if ($items['fornas'] == 1) echo "selected=selected" ?>>FORNAS</option>
																<option value="0" <?php if ($items['fornas'] == 0) echo "selected=selected" ?>>NON FORNAS</option>
															</select>
														</div>
													</div>
												</div>
													...
													<div class="control-group">
														...
														<div class="controls with-tooltip">
															<select id="kd_nomenklatur" name="kd_nomenklatur">
																...
																<option value="3" <?= ($items['kd_nomenklatur'] == 3) ? "selected=selected" :  "" ?>>AMHP</option>
																<option value="1" <?= ($items['kd_nomenklatur'] == 1) ? "selected=selected" : "" ?>>Generic</option>
																<option value="2" <?= ($items['kd_nomenklatur'] == 2) ? "selected=selected" : "" ?>>Non Generic</option>
															</select>
															<span class="help-inline"></span>
															FORNAS
															<select id="fornas" name="fornas" class="input-medium">
										...
										<div class="row-fluid">
											<div class="span12">
												<div class="span6">
													<div class="control-group">
														<label for="kd_golongan" class="control-label">Golongan Obat</label>
														<div class="controls with-tooltip">
															<select id="kd_golongan" name="kd_golongan" class="input-medium">
																...
																foreach ($datagolongan as $gol) {
																	# code...
																	$select = "";
																	if (isset($items['kd_golongan'])) {
																		if ($items['kd_golongan'] == $gol['kd_golongan']) $select = "selected=selected";
																		else $select = "";
																	}
																?>
																	<option value="<?php echo $gol['kd_golongan'] ?>" <?php echo $select; ?>><?php echo $gol['golongan'] ?></option>
																<?php
																}
																?>
															</select>
															...
															<select id="kd_sub" name="kd_sub" class="input-medium">
																...
																foreach ($datasub as $sub) {
																	# code...
																	$select = "";
																	if (isset($items['kd_sub'])) {
																		if ($items['kd_sub'] == $sub['kd_sub']) $select = "selected=selected";
																		else $select = "";
																	}
																?>
																	<option value="<?php echo $sub['kd_sub'] ?>" <?php echo $select; ?>><?php echo $sub['sub_golongan'] ?></option>
																<?php
																}
																?>
															</select>
													...
													<div class="control-group">
														...
														<div class="controls with-tooltip">
															<input align="right" type="text" name="isi_kemasan" id="isi_kemasan" class="span4 input-tooltip"
																value="<?php if (isset($items['isi_kemasan'])) echo $items['isi_kemasan'] ?>" data-placement="bottom" />
														</div>
													</div>
												</div>
											</div>
													...
													<div class="control-group">
														...
														<div class="controls with-tooltip">
															<input align="right" type="text" name="satuan_kecil" id="satuan_kecil" class="span4 input-tooltip"
																value="<?php if (isset($items['satuan_kecil'])) echo $items['satuan_kecil'] ?>" data-placement="bottom" />
														</div>
													</div>
												</div>
											</div>
													...
													<div class="control-group">
														...
														<div class="controls with-tooltip">
															<input align="right" type="text" name="harga_beli" id="harga_beli" class="span4 input-tooltip"
																value="<?php if (isset($items['harga_beli'])) echo $items['harga_beli'] ?>" data-original-title="harga beli rfs" data-placement="bottom" />
														</div>
													</div>
												</div>
											</div>
													...
													<div class="control-group">
														...
														<div class="controls with-tooltip">
															<input align="right" type="text" name="harga_jual" id="harga_jual" class="span4 input-tooltip"
																value="<?php if (isset($items['harga_dasar'])) echo $items['harga_dasar'] ?>" data-original-title="harga beli" data-placement="bottom" />
															<span class="help-inline"></span>
														</div>
													</div>
												</div>
													...
													<div class="control-group">
														...
														<div class="controls with-tooltip">
															<input align="right" type="text" name="harga_apbd" id="harga_apbd" class="span4 input-tooltip"
																value="<?php if (isset($items['harga_apbd'])) echo $items['harga_apbd'] ?>" data-original-title="harga p3k" data-placement="bottom" />
															<span class="help-inline"></span>
														</div>
													</div>
												</div>
													...
													<div class="control-group">
														...
														<div class="controls with-tooltip">
															<input align="right" type="text" name="harga_p3k" id="harga_p3k" class="span4 input-tooltip"
																value="<?php if (isset($items['harga_p3k'])) echo $items['harga_p3k'] ?>" data-original-title="harga_p3k" data-placement="bottom" />
															<span class="help-inline"></span>
														</div>
													</div>
												</div>
													...
													<div class="control-group">
														...
														<div class="controls with-tooltip">
															<input align="right" type="text" name="harga_buffer" id="harga_buffer" class="span4 input-tooltip"
																value="<?php if (isset($items['harga_buffer'])) echo $items['harga_buffer'] ?>" data-original-title="harga buffer" data-placement="bottom" />
															<span class="help-inline"></span>
														</div>
													</div>
												</div>
													...
													<div class="control-group">
														...
														<div class="controls with-tooltip">
															<input align="right" type="text" name="harga_jpkmm" id="harga_jpkmm" class="span4 input-tooltip"
																value="<?php if (isset($items['harga_jpkmm'])) echo $items['harga_jpkmm'] ?>" data-original-title="harga jpkmm" data-placement="bottom" />
															<span class="help-inline"></span>
														</div>
													</div>
												</div>
													...
													<div class="control-group">
														...
														<div class="controls with-tooltip">
															<input align="right" type="text" name="harga_program" id="harga_program" class="span4 input-tooltip"
																value="<?php if (isset($items['harga_program'])) echo $items['harga_program'] ?>" data-original-title="harga program" data-placement="bottom" />
															<span class="help-inline"></span>
														</div>
													</div>
												</div>
													...
													<div class="control-group">
														...
														<div class="controls with-tooltip">
															<input align="right" type="text" name="harga_dak" id="harga_dak" class="span4 input-tooltip"
																value="<?php if (isset($items['harga_dak'])) echo $items['harga_dak'] ?>" data-original-title="harga dak" data-placement="bottom" />
															<span class="help-inline"></span>
														</div>
													</div>
												</div>
											...
											<div id="div-2" class="accordion-body collapse in body">
															...
															<div class="control-group">
																...
																<div class="controls with-tooltip">
																	<input align="right" type="text" name="min_stok" id="min_stok" class="span3 input-tooltip"
																		value="<?php if (isset($itemsetting['min_stok'])) echo $itemsetting['min_stok'] ?>" data-original-title="min stok" data-placement="bottom" />
																	<span class="help-inline"></span>
																</div>
															</div>
														</div>
												...
												<div class="row-fluid">
													<div class="span12">
														<div class="span5">
															<div class="control-group">
																<label for="max_stok" class="control-label">EOQ / Maximum Stok</label>
																<div class="controls with-tooltip">
																	<input align="right" type="text" name="max_stok" id="max_stok" class="span3 input-tooltip"
																		value="<?php if (isset($itemsetting['max_stok'])) echo $itemsetting['max_stok'] ?>" data-original-title="max stok" data-placement="bottom" />
																	<span class="help-inline"></span>
																</div>
															</div>
														</div>
										...
										<div class="box error">
											...
											<div class="body collapse in" id="defaultTable">
												<table class="table responsive">
													...
													<tbody id="bodyinput">
														<?php
														if (isset($databarcode)) {
															foreach ($databarcode as $bar) {
																# code...
														?>
																<tr>
																	<td style="text-align:center;"><input type="checkbox" class="barisinput cleared" /></td>
																	<td><input type="text" name="kd_barcode[]" value="<?php echo $bar['kd_barcode'] ?>" class="input-medium bariskodeobat cleared"></td>
																	<td><select name='kd_satuan_barcode[]' class='input-medium'>
																			<?php
																			foreach ($datakecil as $kecil) {
																				if ($kecil['kd_satuan_kecil'] == $bar['kd_satuan']) $sel = "selected";
																				else $sel = "";
																			?>
																				<option value="<?php echo $kecil['kd_satuan_kecil'] ?>" <?php echo $sel; ?>><?php echo $kecil['satuan_kecil'] ?></option>
																			<?php
																			}
																			?>
																		</select>
																	</td>
																	<td><input type="text" name="deskripsi[]" value="<?php echo $bar['deskripsi'] ?>" autocomplete="off" style="width:300px !important;" class="input-large barisnamaobat cleared"></td>
																	<td><input type="text" name="fractions[]" required value="<?php echo $bar['fractions'] ?>" style="text-align:right;" class="input-small barisqty cleared"></td>
																</tr>
														<?php
															}
														}
