		...
		$('#satuan_kecil').focus();
            $('#form').ajaxForm({
                beforeSubmit: function(a,f,o) {
                    ...
                    url: "<?php echo base_url(); ?>index.php/masterapotek/puskesmas/periksa",
                    type:"POST",
                    async: false,
                    data: $.param(a),
                ...
                //data = objToString(data);
                    if(parseInt(data.status)==1) //jika berhasil
                    {
						...
						if(parseInt(data.posting)==3){
							 window.location.href='<?php echo base_url(); ?>index.php/masterapotek/puskesmas/edit/'+data.id;
						}
					}
                                ...
                                <div class="span12">
                                    <div class="box">
                                        <header>
                                            ...
                                            <div class="toolbar" style="height:auto;">
                                                <ul class="nav nav-tabs">
													<li><a href="<?php echo base_url() ?>index.php/masterapotek/puskesmas/"> <i class="icon-list"></i> Daftar </a></li>
													<li><a href="<?php echo base_url() ?>index.php/masterapotek/puskesmas/tambah"> <i class="icon-plus"></i> Tambah </a></li>
                                                    <!--<li class="dropdown">
                                        ...
                                        <div id="div-1" class="accordion-body collapse in body">
                                            <form class="form-horizontal" id="form" method="post" action="<?php echo base_url()?>index.php/masterapotek/puskesmas/update">
                                                    ...
                                                    <div class="span12">
                                                        <div class="control-group">
                                                            ...
                                                            <div class="controls with-tooltip">
                                                                <input type="text" name="idx" id="idx" disabled class="span2 input-tooltip"
                                                                    value="<?php echo $items['id'] ?>" data-original-title="kd satuan" data-placement="bottom"/>
                                                                <input type="hidden" name="id" id="id"  class="span2 input-tooltip"
                                                                    value="<?php echo $items['id'] ?>" data-original-title="kd satuan" data-placement="bottom"/>
                                                ...
                                                <div class="row-fluid">
                                                    <div class="span12">                                                        
                                                        <div class="control-group">
                                                            ...
                                                            <div class="controls with-tooltip">
                                                                <input type="text" name="nama" id="nama" required class="span5 input-tooltip"
                                                                    value="<?php echo $items['nama'] ?>" data-original-title="" data-placement="bottom"/>
                                                                <span class="help-inline"></span>
                                                            </div>
                                                        </div>                                                      
                                                    </div>
                                                ...
                                                <div class="row-fluid">
                                                    <div class="span12">                                                        
                                                        <div class="control-group">
                                                            ...
                                                            <div class="controls with-tooltip">
                                                                <input type="text" name="telepon" id="telepon" class="span5 input-tooltip"
                                                                    value="<?php echo $items['telepon'] ?>" data-original-title="" data-placement="bottom"/>
                                                                <span class="help-inline"></span>
                                                            </div>
                                                        </div>                                                      
                                                    </div>
                                                ...
                                                <div class="row-fluid">
                                                    <div class="span12">                                                        
                                                        <div class="control-group">
                                                            ...
                                                            <div class="controls with-tooltip">
                                                                <input type="text" name="email" id="email" class="span5 input-tooltip"
                                                                    value="<?php echo $items['email'] ?>" data-original-title="" data-placement="bottom"/>
                                                                <span class="help-inline"></span>
                                                            </div>
                                                        </div>                                                      
                                                    </div>
                                                ...
                                                <div class="row-fluid">
                                                    <div class="span12">                                                        
                                                        <div class="control-group">
                                                            ...
                                                            <div class="controls with-tooltip">
                                                                <input type="text" name="alamat" id="alamat" class="span5 input-tooltip"
                                                                    value="<?php echo $items['alamat'] ?>" data-original-title="" data-placement="bottom"/>
                                                                <span class="help-inline"></span>
                                                            </div>
                                                        </div>                                                      
                                                    </div>
