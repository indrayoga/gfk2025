                                ...
                                <div class="span12">
                                    <div class="box">
                                        ...
                                        <div id="div-1" class="accordion-body collapse in body">
                                            <form class="form-horizontal" id="form" method="post" action="<?php echo base_url()?>index.php/masterapotek/puskesmas/simpan">
                                                <div class="row-fluid">
                                                    <div class="span12">
														<div class="control-group">
															<label for="id" class="control-label">Kode</label>
															<div class="controls with-tooltip">
																<input type="text" name="id" id="id" disabled class="span2 input-tooltip"
																	value="" data-original-title="kd satuan" data-placement="bottom"/>
                                                        ...
                                                        <div class="control-group">
                                                            ...
                                                            <div class="controls with-tooltip">
                                                                <input type="text" name="nama" id="nama" required class="span5 input-tooltip"
                                                                    value="" data-original-title="" data-placement="bottom"/>
                                                                <span class="help-inline"></span>
                                                            </div>
                                                        </div>                                                      
                                                    </div>
