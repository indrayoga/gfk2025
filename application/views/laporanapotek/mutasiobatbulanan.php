...
<script type="text/javascript">
    $(document).ready(function() {
        $('#cetak').click(function() {
            ...
            window.location.href = '<?php echo base_url() ?>index.php/transapotek/laporanapt/excellplpobulanan/' + bulan + '/' + bulan1 + '/' + tahun + '/' + kd_unit_apt + '/' + kd_kategori;
        })
    });
</script>
<div id="error"></div>
                    ...
                    <div class="span12">
                        <div class="box">
                            <header>
                                ...
                                <h5>LAPORAN MUTASI OBAT BULANAN/TAHUNAN</h5>
                                <!-- .toolbar -->
                            ...
                            <div id="div-1" class="accordion-body collapse in body">
                                <form id="form" class="form-horizontal" method="POST" action="<?php echo base_url() ?>index.php/transapotek/laporanapt/bulanan">
                                                    ...
                                                    <div class="control-group">
                                                        ...
                                                        <div class="controls with-tooltip">
                                                            <select name="kd_kategori" class="input-medium">
                                                                ...
                                                                <option value="obat" <?= ($kd_kategori == 'obat') ? 'selected=selected' : '' ?>>Obat</option>
                                                                <option value="bmhp" <?= ($kd_kategori == 'bmhp') ? 'selected=selected' : '' ?>>BMHP</option>
                                                                <option value="bahan_gigi" <?= ($kd_kategori == 'bahan_gigi') ? 'selected=selected' : '' ?>>Bahan Gigi</option>
                                                                <option value="bahan_kimia" <?= ($kd_kategori == 'bahan_kimia') ? 'selected=selected' : '' ?>>Bahan Kimia/Reagen</option>
                                                            </select>
                                    ...
                                    <tbody id="listmutasi">
                                        ...
                                        ?>
                                            <tr style="font-size:80% !important;">
                                                ...
                                                <td style="text-align:right;width:15px !important;"><?php if ($item['kd_obat'] != '') echo number_format($item['saldo_awal_apbn'], 2, '.', ',') ?></td>
                                                <td style="text-align:right;width:15px !important;"><?php if ($item['kd_obat'] != '') echo number_format($item['saldo_awal_program'], 2, '.', ',') ?></td>
                                                <td style="text-align:right;width:15px !important;"><?php if ($item['kd_obat'] != '') echo number_format($item['saldo_awal_apbd1'], 2, '.', ',') ?></td>
                                                <td style="text-align:right;width:15px !important;"><?php if ($item['kd_obat'] != '') echo number_format($item['saldo_awal_apbd2'], 2, '.', ',') ?></td>
                                                <td style="text-align:right;width:15px !important;"><?php if ($item['kd_obat'] != '') echo number_format($item['saldo_awal_lain'], 2, '.', ',') ?></td>
                                                <td style="text-align:right;width:15px !important;"><?php if ($item['kd_obat'] != '') echo number_format($item['jum_masuk_apbn'], 2, '.', ',') ?></td>
                                                <td style="text-align:right;width:15px !important;"><?php if ($item['kd_obat'] != '') echo number_format($item['jum_masuk_program'], 2, '.', ',') ?></td>
                                                <td style="text-align:right;width:15px !important;"><?php if ($item['kd_obat'] != '') echo number_format($item['jum_masuk_apbd1'], 2, '.', ',') ?></td>
                                                <td style="text-align:right;width:15px !important;"><?php if ($item['kd_obat'] != '') echo number_format($item['jum_masuk_apbd2'], 2, '.', ',') ?></td>
                                                <td style="text-align:right;width:15px !important;"><?php if ($item['kd_obat'] != '') echo number_format($item['jum_masuk_lain'], 2, '.', ',') ?></td>
                                                <td style="text-align:right;width:15px !important;"><?php if ($item['kd_obat'] != '') echo number_format($item['jum_keluar_apbn'], 2, '.', ',') ?></td>
                                                <td style="text-align:right;width:15px !important;"><?php if ($item['kd_obat'] != '') echo number_format($item['jum_keluar_program'], 2, '.', ',') ?></td>
                                                <td style="text-align:right;width:15px !important;"><?php if ($item['kd_obat'] != '') echo number_format($item['jum_keluar_apbd1'], 2, '.', ',') ?></td>
                                                <td style="text-align:right;width:15px !important;"><?php if ($item['kd_obat'] != '') echo number_format($item['jum_keluar_apbd2'], 2, '.', ',') ?></td>
                                                <td style="text-align:right;width:15px !important;"><?php if ($item['kd_obat'] != '') echo number_format($item['jum_keluar_lain'], 2, '.', ',') ?></td>
                                                <td style="text-align:right;width:15px !important;"><?php if ($item['kd_obat'] != '') echo number_format($item['total_jum_keluar'], 2, '.', ',') ?></td>
                                                <td style="text-align:right;width:25px !important;"><?php if ($item['kd_obat'] != '') echo number_format($item['saldo_akhir_apbn'], 2, '.', ',') ?></td>
                                                <td style="text-align:right;width:25px !important;"><?php if ($item['kd_obat'] != '') echo number_format($item['saldo_akhir_program'], 2, '.', ',') ?></td>
                                                <td style="text-align:right;width:25px !important;"><?php if ($item['kd_obat'] != '') echo number_format($item['saldo_akhir_apbd1'], 2, '.', ',') ?></td>
                                                <td style="text-align:right;width:25px !important;"><?php if ($item['kd_obat'] != '') echo number_format($item['saldo_akhir_apbd2'], 2, '.', ',') ?></td>
                                                <td style="text-align:right;width:25px !important;"><?php if ($item['kd_obat'] != '') echo number_format($item['saldo_akhir_lain'], 2, '.', ',') ?></td>
                                                <td style="text-align:right;width:25px !important;"><?php if ($item['kd_obat'] != '') echo number_format($item['total_saldo_akhir'], 2, '.', ',') ?></td>
                                                <td style="text-align:right;width:25px !important;"><?php if ($item['kd_obat'] != '') echo number_format($item['rata_pemakaian'], 2, '.', ',') ?></td>
                                                <td style="text-align:right;width:25px !important;"><?php if ($item['kd_obat'] != '') echo number_format($item['kecukupan'], 2, '.', ',') ?></td>
                                            </tr>
                                        <?php
                                            $no++;
                                        }
