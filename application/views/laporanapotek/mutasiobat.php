...
<script type="text/javascript">
    $(document).ready(function() {
        $('#cetak').click(function() {
            ...
            window.location.href = '<?php echo base_url() ?>index.php/transapotek/laporanapt/excellplpo/' + bulan + '/' + tahun + '/' + kd_unit_apt + '/' + kd_kategori;
        })
    });
</script>
<div id="error"></div>
                                    ...
                                    <tbody id="listmutasi">
                                        ...
                                        ?>
                                            <tr style="font-size:80% !important;">
                                                ...
                                                <td style="width:25px !important;"><?php echo number_format($item['harga_beli'], 2, '.', ',') ?></td>
                                                ...
                                                <td style="text-align:right;width:15px !important;"><?php if ($opt > 0) echo number_format($item['saldo_akhir'] / $opt, 2, '.', ',');
                                                                                                    else echo 0; ?></td>
