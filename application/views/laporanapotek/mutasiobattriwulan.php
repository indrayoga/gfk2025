...
<script type="text/javascript">
    $(document).ready(function() {
        $('#cetak').click(function() {
            ...
            window.location.href = '<?php echo base_url() ?>index.php/transapotek/laporanapt/rl1excelmutasitriwulan/' + triwulan + '/' + tahun + '/' + kd_kategori;
        })
    });
</script>
<?php
                                    ...
                                    <tbody id="listmutasi">
                                        ...
                                        ?>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align:right;"><?php //echo number_format($hitung_saldo_awal,2,'.',',')
                                                                                ?></td>
                                                <td style="text-align:right;"><?php //echo number_format($hitung_harga_saldo_awal,2,'.',',')
                                                                                ?></td>
                                                <td style="text-align:right;"><?php echo number_format($hitung_jumlah_saldo_awal, 2, '.', ',') ?></td>

                                                <td style="text-align:right;"><?php //echo number_format($hitung_mutasi_masuk,2,'.',',')
                                                                                ?></td>
                                                <td style="text-align:right;"><?php //echo number_format($hitung_harga_mutasi_masuk,2,'.',',')
                                                                                ?></td>
                                                <td style="text-align:right;"><?php echo number_format($hitung_jumlah_mutasi_masuk, 2, '.', ',') ?></td>

                                                <td style="text-align:right;"><?php //echo number_format($hitung_mutasi_keluar,2,'.',',')
                                                                                ?></td>
                                                <td style="text-align:right;"><?php //echo number_format($hitung_harga_mutasi_keluar,2,'.',',')
                                                                                ?></td>
                                                <td style="text-align:right;"><?php echo number_format($hitung_jumlah_mutasi_keluar, 2, '.', ',') ?></td>

                                                <td style="text-align:right;"><?php //echo number_format($hitung_mutasi_karantina,2,'.',',')
                                                                                ?></td>
                                                <td style="text-align:right;"><?php //echo number_format($hitung_harga_mutasi_karantina,2,'.',',')
                                                                                ?></td>
                                                <td style="text-align:right;"><?php echo number_format($hitung_jumlah_mutasi_karantina, 2, '.', ',') ?></td>

                                                <td style="text-align:right;"><?php //echo number_format($hitung_saldo_akhir,2,'.',',')
                                                                                ?></td>
                                                <td style="text-align:right;"><?php //echo number_format($hitung_harga_saldo_akhir,2,'.',',')
                                                                                ?></td>
