                                ...
                                <div class="span12">
                                    <div class="box">
                                        ...
                                        <div id="div-1" class="accordion-body collapse in body">
                                            <form class="form-horizontal" method="POST" action="<?php echo base_url() ?>index.php/transapotek/laporanapt/kartustokbatch">
                                                ...
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls with-tooltip">
														...
														<input type="hidden" id="kd_milik" name="kd_milik" value="01" class="span3 input-tooltip" data-original-title="kd obat" data-placement="bottom"/>
														<input type="hidden" id="kd_unit_apt_obat" name="kd_unit_apt_obat" value="<?php echo $kd_obat?>" class="span3 input-tooltip" data-original-title="kd obat" data-placement="bottom"/>
														<input type="hidden" id="kd_pabrik" name="kd_pabrik" value="<?php echo $kd_pabrik?>" class="span3 input-tooltip" data-original-title="kd obat" data-placement="bottom"/>
														<input type="hidden" id="tgl_expire" name="tgl_expire" value="<?php echo $tgl_expire?>" class="span3 input-tooltip" data-original-title="kd obat" data-placement="bottom"/>
														...
														<input type="hidden" id="harga_pokok" name="harga_pokok" value="<?php echo $harga_pokok?>" class="span3 input-tooltip" data-original-title="kd obat" data-placement="bottom"/>
                                                    </div>
                                                </div>
                                                <div class="control-group">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        <tr style="font-size:95% !important;">
                                                            ...
                                                            <td>
                                                                <?php
                                                                    if($item['status']=='SO')echo "SO";
                                                                    if($item['status']=='M')echo "Penerimaan";
                                                                    if($item['status']=='K')echo "Pengeluaran";
...
<script type="text/javascript">
	...
	function pilihobat(kd_obat,nama_obat,kd_unit_apt,kd_milik,kd_pabrik,tgl_expire,harga_pokok,batch) {
		$('#kd_obat').val(kd_obat);
        $('#nama_obat').val(nama_obat);
        $('#kd_unit_apt_obat').val(kd_unit_apt);
        $('#kd_milik').val(kd_milik);
        $('#kd_pabrik').val(kd_pabrik);
        $('#tgl_expire').val(tgl_expire);
	...
	$('#nama_obat').keyup(function(e){
		if(e.keyCode == 13){
			...
			$('#dataTable4').dataTable( {
				"bProcessing": true,
				"bServerSide": true,
				"sAjaxSource": "<?php echo base_url() ?>index.php/transapotek/laporanapt/ambilobatbynamabatch/",
				"sServerMethod": "POST",
