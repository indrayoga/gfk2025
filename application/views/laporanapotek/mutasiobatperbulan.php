...
<script type="text/javascript">
    $(document).ready(function() {
        $('#cetak').click(function() {
            ...
            window.location.href = '<?php echo base_url() ?>index.php/transapotek/laporanapt/excellplpobulanan2/' + bulan + '/' + bulan1 + '/' + tahun + '/' + kd_unit_apt + '/' + kd_nomenklatur + '/' + bulan_kebutuhan + '/' + kategori + '/' + kd_kategori;
        })
    });
</script>
<div id="error"></div>
                    ...
                    <div class="span12">
                        <div class="box">
                            ...
                            <div id="div-1" class="accordion-body collapse in body">
                                <form id="form" class="form-horizontal" method="POST" action="<?php echo base_url() ?>index.php/transapotek/laporanapt/mutasiobatbulanan">
                                    ...
                                    <div class="row-fluid">
                                        ...
                                        <div class="row-fluid">
                                            <div class="span12">
                                                <div class="span6">
                                                    <div class="control-group">
                                                        <label for="bulan_kebutuhan" class="control-label">Bulan Kebutuhan</label>
                                                        <div class="controls with-tooltip">
                                                            <input type="text" name="bulan_kebutuhan" id="bulan_kebutuhan" value="<?= $bulan_kebutuhan ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
