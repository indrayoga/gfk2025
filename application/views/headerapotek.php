    ...
    <script type="text/javascript">
        ...
        <?php if ($this->session->userdata('kd_unit_apt') != $this->session->userdata('kd_unit_apt_gudang')) { ?>
            ...
            Mousetrap.bindGlobal('f9', function() {
                window.location.href = '<?php echo base_url() ?>index.php/transapotek/returpenjualanobat';
                return false;
            });
        <?php } else { ?>
        ...
        Mousetrap.bindGlobal('f10', function() {
            window.location.href = '<?php echo base_url() ?>index.php/transapotek/aptdistribusi';
            return false;
        });
                        ...
                        <div class="btn-toolbar topnav">
                            ...
                            <div class="btn-group">
                                <a class="btn btn-inverse" data-placement="bottom" data-original-title="Logout" rel="tooltip"
                                    href="<?php echo base_url() ?>index.php/home/logout"><i class="icon-off"></i></a>
                            </div>
                        </div>
                        <!-- /.topnav -->
                        <div class="nav-collapse collapse">
                            ...
                            <ul class="nav">
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li class="dropdown submenu">
                                            <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class=" icon-doc-1"></i>Laporan Stok</a>
                                            <ul class="dropdown-menu submenu-show submenu-hide">
                                        ...
                                        <li class="dropdown submenu">
                                            <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class=" icon-doc-1"></i>Laporan Pengeluaran Obat</a>
                                            <ul class="dropdown-menu submenu-show submenu-hide">
                                        ...
                                        <li class="dropdown submenu">
                                            <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class=" icon-doc-1"></i>Laporan Penerimaan Obat</a>
                                            <ul class="dropdown-menu submenu-show submenu-hide">
                                                ...
                                                <li><a href="<?php echo base_url() ?>index.php/transapotek/laporanapt/obatsas"><i class="icon-angle-right"></i> Obat SAS</a></li>
                                                <li><a href="<?php echo base_url() ?>index.php/gfk/laporangfk/lappenerimaanobat"><i class="icon-angle-right"></i> Laporan Penerimaan Obat per Harga</a></li>
                                            </ul>
                                        </li>
