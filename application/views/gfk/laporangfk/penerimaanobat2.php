                    ...
                    <div class="span12">
                        <div class="box">
                            ...
                            <div id="div-1" class="accordion-body collapse in body">
                                <form class="form-horizontal" method="POST" action="<?php echo base_url() ?>index.php/gfk/laporangfk/lappenerimaanobat">
                                    <div class="row-fluid">
                                        <div class="span12">
                                            <div class="span6">
